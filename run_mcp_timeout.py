...
class MCPRunner:
    ...
    def __init__(self):
        ...
        self.agent = MCPAgent()
        # Set a shorter timeout for LLM calls
        self.agent.llm_timeout = 30  # 30 seconds timeout
    ...
    async def run_default(self) -> None:
        ...
        try:
            ...
            await asyncio.wait_for(self.agent.run(prompt), timeout=60)
            logger.info("Request processing completed.")
        except asyncio.TimeoutError:
            logger.error("Request timed out after 60 seconds.")
            print("Request timed out. The operation took too long to complete.")
